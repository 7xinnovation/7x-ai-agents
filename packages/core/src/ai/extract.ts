...
export async function extractFieldsFromDocument(input: {
  ...
  const instruction =
    ...
    "- AN ADDRESS PRINTED ONLY IN ARABIC STILL HAS A DISTRICT IN IT. Many Dubai licences print no English address at all: the whole address, district included, is one Arabic line. Read the district out of it and fill BOTH region fields — the Arabic text in the Arabic region field, and the district's OFFICIAL ENGLISH NAME in the English one. That is not transliterating a name: a district is a place with a published bilingual name, and the English form is the one the licensing system stores. \u0628\u0631\u062f\u0628\u064a is Bur Dubai, \u0628\u0632\u0646\u0633 \u0628\u064a is Business Bay, \u062f\u064a\u0631\u0629 is Deira, \u0627\u0644\u0642\u0648\u0632 is Al Quoz, \u0627\u0644\u0628\u0631\u0634\u0627\u0621 is Al Barsha, \u0627\u0644\u0645\u0646\u062e\u0648\u0644 is Al Mankhool, \u0627\u0644\u0631\u0642\u0629 is Al Rigga, \u0627\u0644\u0648\u0631\u0642\u0627\u0621 is Al Warqa, \u0627\u0644\u0642\u0635\u064a\u0635 is Al Qusais, \u0645\u0631\u062f\u0641 is Mirdif, \u062c\u0628\u0644 \u0639\u0644\u064a is Jebel Ali. Leaving the region empty because the line is Arabic makes the application ask the customer for something already printed on the document they just gave you.\n" +
    "- AND PUT AN ARABIC-ONLY ADDRESS IN THE ARABIC ADDRESS FIELD, not the English one. If the licence prints the address in one script only, the other address field stays empty rather than holding the wrong script.\n" +
