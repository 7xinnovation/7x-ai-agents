...
const flow = (customerType: "personal" | "corporate") => {
  ...
  return [
    ...
    `3) Branches: call the Rental/BoxLocations tool with BundleId=<chosen bundle_Id> and EmirateCode=<code>. Present the returned offices as CARDS (nameEn, workingTime). Remember each office's officeId.`,
